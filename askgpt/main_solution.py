...
with open('/Users/jparmas/Desktop/DeepLearningWorkshop/askgpt/prompts.yaml') as f:
...
def fill_prompt(task):
    ...
    placeholders = {v[1]: "" for v in string.Formatter().parse(
        prompt) if v[1] is not None}
